...
(function () {
    ...
    function Airport (name, listOfFlight) {
        ...
        this.getData = function () {
            let result = `Airport:' + $(this.name) + total passenger: + $(this.getPassengersNumber())`
            this.listOfFlight.forEach(function(flight) {
    ...
    let belgradeParis = new Flight ('Belgrade - Paris', 'Oct 25 2017');
    let barselonaBelgrade = new Flight ('Barcelona - Belgrade', 'Nov 11 2017');

    //var marija = new Person('Marija', 'Andjelkovic');
    //var seat1 = new Seat (67, 'e');
    //var passenger1 = new Passenger (marija, seat1);
    let passenger1 = createPassenger ('Marija', 'Andjelkovic', 67, 'e');

    let passenger2 = createPassenger ('Cersei', 'Lannister', 1, 'b' );
    ...
    let passenger4 = createPassenger ('Sofija', 'Dolgorukov')
